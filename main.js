...
function startGame()
{
  ...
  document.getElementById("staus").innerHTML = "Game has loaded";//Update the h3 tag which we have created inside index.html file in project 138 who has id “status” to "Game Is Loaded”.
}
